...
func (store *SQLStore) execTx(ctx context.Context, fn func(*Queries) error) error {
	...
	if err != nil {
		...
		// ngu lon khong return loi dan den khong sinh ra loi deadlock
		return err
	}
...
// It create a transfer record, add account entries, update accounts balance within a single db transaction
